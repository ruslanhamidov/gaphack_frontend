<template>
  <a
    ...
    :class="['discord-btn', variant === 'lg' ? 'discord-btn--lg' : '']"
  >
    ...
    {{ variant === 'lg' ? 'Join our Discord' : 'Discord' }}
  </a>
</template>
...
defineProps({
  variant: {
    type: String,
    default: 'default' // 'default' for nav, 'lg' for hero
  }
})

const discordUrl = import.meta.env.VITE_DISCORD_URL || 'https://discord.com'
</script>
